...
public final class Constants {
  ...
  public final class Flywheel {
    ...
    public static final double hubToleranceDegrees = 1.0;
  ...
  public static final class Vision {
    ...
    public static Translation2d INTAKE_CAM_TRANSLATION =
        new Translation2d(Units.inchesToMeters(14), 0); // TODO should this be negative, since the intake is in the back?
    ...
    public static double TRAJECTORY_MAX_CARGO_DISTANCE =
        Units.inchesToMeters(60); // TODO Get reliability measurement
  }
