...
public class TwoBallAuto extends SequentialCommandGroup {
    ...
    public TwoBallAuto(
        ...
        Trajectory trajectory1 = PathPlanner.loadPath("TwoBallAuto-1", Units.feetToMeters(8), Units.feetToMeters(7),
                true);

        VitruvianRamseteCommand command1 = TrajectoryUtils.generateRamseteCommand(driveTrain, trajectory1);
        /**
         * Order of operations: drivetrain & intake & indexer & vision run until
         * drivetrain stops
         * (except for vision) run indexer & flywheel until indexer stops end sequence
         * Turn and move
         * forward to line up with blue ball on other side of the line (NOT running
         * intake, indexer,
