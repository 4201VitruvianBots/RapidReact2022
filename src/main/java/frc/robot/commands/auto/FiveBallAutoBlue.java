  ...
  public FiveBallAutoBlue(
    ...
    Trajectory trajectory1 =
        PathPlanner.loadPath(
            "FiveBallAutoBlue-1", Units.feetToMeters(9), Units.feetToMeters(7), true);
    VitruvianRamseteCommand command1 =
        TrajectoryUtils.generateRamseteCommand(driveTrain, trajectory1);

    Trajectory trajectory2 =
        PathPlanner.loadPath(
            "FiveBallAutoBlue-2", Units.feetToMeters(9), Units.feetToMeters(6), false);
    VitruvianRamseteCommand command2 =
        TrajectoryUtils.generateRamseteCommand(driveTrain, trajectory2);

    Trajectory trajectory3 =
        PathPlanner.loadPath(
            "FiveBallAutoBlue-3", Units.feetToMeters(12), Units.feetToMeters(10), true);
    VitruvianRamseteCommand command3 =
        TrajectoryUtils.generateRamseteCommand(driveTrain, trajectory3);

    Trajectory trajectory4 =
        PathPlanner.loadPath(
            "FiveBallAutoBlue-4", Units.feetToMeters(12), Units.feetToMeters(9), false);
