...
public class EjectAll extends CommandBase {
  ...
  /**
   * Called every time the scheduler runs while the command is scheduled. Spins the Indexer, Kicker,
   * and Intake Backwards
   */
  @Override
  public void execute() {
  ...
  /**
   * Called once the command ends or is interrupted. Sets the Kicker, Indexer, and Intake speed to 0
   */
  @Override
