...
public class Flywheel extends SubsystemBase {
    ...
    public double getRPM(int motorIndex) {
        return flywheelMotors[motorIndex].getSelectedSensorVelocity() * (600.0 / encoderUnitsPerRotation);
    } 
    ...
    private void updateShuffleboard() {
        if (RobotBase.isReal()) {
            SmartDashboard.putNumber("RPM", flywheelMotors[0].getSelectedSensorVelocity() * (600.0 / encoderUnitsPerRotation));
