...
public class TrajectoryUtils {
    ...
    try {
      ...
      while ((fileLine = reader.readLine()) != null) {
        ...
        trajectoryPoints.add(
            new Pose2d(
                Units.feetToMeters(Double.parseDouble(fields[0])),
  ...
  public static VitruvianRamseteCommand generateRamseteCommand(
      DriveTrain driveTrain, ArrayList<Pose2d> path, TrajectoryConfig config) {
  ...
  public static VitruvianRamseteCommand generateRamseteCommand(
      DriveTrain driveTrain, Trajectory trajectory) {

    VitruvianRamseteCommand ramseteCommand =
        new VitruvianRamseteCommand(
            trajectory,
